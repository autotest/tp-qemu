...
from provider import disk_utilities
...
def run(test, params, env):
    ...
    tmp_dir = params.get("tmp_dir", "/var/tmp/test")
    disk_utilities.execute_cmd_on_disk_by_id(
        params, qtree_check_images[0], session, tmp_dir
    )
