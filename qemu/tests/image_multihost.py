...
def run(test, params, env):
    ...
    test.log.info("Images defined in 'images' are taken care of by preprocess")
    ...
    test.log.info("Now we create image %s step by step", test_image_tag)
    conf = imgr.define_logical_image_config(test_image_tag, params)
    images[test_image_tag] = imgr.create_logical_image_object(conf)
    ...
    test.log.info("Now we backup the image %s", test_image_tag)
    ...
    test.log.info("Now we restore the image %s", test_image_tag)
    ...
    test.log.info("Now we clone the image %s", test_image_tag)
    ...
    imgr.destroy_logical_image_object(images[test_image_tag])
