...
class QSDBackupPullMode(blockdev_base.BlockdevBaseTest):
    ...
    def __init__(self, test, params, env):
        super(QSDBackupPullMode, self).__init__(test, params, env)
        self.source_images = []
        self.full_backups = []
        self.inc_backups = []
    ...
    def do_full_backup(self):
        ...
        self.backup_jobs = [job['id']
                            for job in job_utils.query_jobs(self.qsd)]
    ...
    def restart_vm_with_backup_images(self):
        ...
        self.params['qsd_images_qsd1'] = ' '.join([i.tag for i in self.inc_backup_client_images])
    ...
    def verify_data_files(self):
        ...
        super(QSDBackupPullMode, self).verify_data_files()
    ...
    def prepare_test(self):
        ...
        super(QSDBackupPullMode, self).prepare_test()

    def post_test(self):
        super(QSDBackupPullMode, self).post_test()
        self.qsd.stop_daemon()
