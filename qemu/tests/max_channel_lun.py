...
def run(test, params, env):
    ...
    if params['luns'] == "lun_33":
        ...
        image = qemu_storage.QemuImg(img_params, data_dir.get_data_dir(),
                                     "stg32")
        params["extra_params"] = "-blockdev node-name=file_stg32,\
...
drive=drive_stg32,write-cache=on,channel=0" % image.image_filename
        image.create(params)
    params['start_vm'] = 'yes'
    try:
