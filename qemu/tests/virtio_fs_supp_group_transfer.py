    ...
    def _basic_io_test(test, params, session, fs_dest, fs_source):
        ...
        try:
            if windows:
                ...
                driver_letter = virtio_fs_utils.get_virtiofs_driver_letter(test,
                                                                           fs_target,
                                                                           session)
        ...
        virtio_fs_utils.create_sub_folder_test(params, session, fs_dest,
                                               fs_source)
